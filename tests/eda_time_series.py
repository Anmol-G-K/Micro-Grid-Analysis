...
# Define user-specific numeric columns
USER_NUMERIC_COLS = [
...
# Define user-specific column pairs for analysis
USER_PAIRS = [
    ("solar_pv_output", "wind_power_output"),  # Relationship between solar and wind power outputs
    ("solar_pv_output", "temperature"),  # Relationship between solar power and ambient temperature
    ("wind_power_output", "temperature"),  # Relationship between wind power and temperature
    ("battery_state_of_charge", "grid_load_demand"),  # Battery state of charge vs grid demand
]

# Define groups of related columns based on the domain of interest
COL_GROUPS = {
    "renewable_energy": ["solar_pv_output", "wind_power_output", "total_renewable_energy", "solar_irradiance", "wind_speed"],
    "weather": ["temperature", "humidity", "atmospheric_pressure", "frequency"],  # Weather-related columns
    "energy_demand": ["grid_load_demand", "power_exchange", "battery_state_of_charge", "battery_charging_rate", "battery_discharging_rate"],
    "predictions": ["predicted_solar_pv_output", "predicted_wind_power_output", "total_predicted_energy"]
}
